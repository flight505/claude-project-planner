...
class DocxXMLEditor(XMLEditor):
    ...
    def __init__(
        self, xml_path, rsid: str, author: str = "Project-Planner", initials: str = "SW"
    ):
        ...
        Args:
            ...
            author: Author name for tracked changes and comments (default: "Project-Planner")
...
class Document:
    ...
    def __init__(
        ...
        Args:
            ...
            author: Default author name for comments (default: "Project-Planner")
